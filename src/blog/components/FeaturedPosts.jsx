...
// The homepage featured section: one large lead card plus up to three smaller
...
const fetchPost = async () => {
  const res = await api.get("/posts?featured=true&limit=4&sort=newest");
  return res.data;
};
    ...
    <div className="mt-8 flex flex-col lg:flex-row gap-8">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            to={`/blog/posts?cat=${posts[0].category}`}
          ...
          <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="w-2/3">
              ...
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                ...
                <Link
                  to={`/blog/posts?cat=${posts[1].category}`}
          ...
          <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="w-2/3">
              ...
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                ...
                <Link
                  to={`/blog/posts?cat=${posts[2].category}`}
                  className="text-blue-800"
                >
                  {posts[2].category}
                </Link>
          ...
          <div className="lg:h-1/3 flex justify-between gap-4">
            ...
            <div className="w-2/3">
              ...
              <div className="flex items-center gap-4 text-sm lg:text-base mb-4">
                ...
                <Link
                  to={`/blog/posts?cat=${posts[3].category}`}
                  className="text-blue-800"
                >
                  {posts[3].category}
                </Link>
