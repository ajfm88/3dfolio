        ...
        >
          ...
          >
            Hi, I'm <span className='relative inline-block'>
              <span className='text-[#915EFF] hover:text-white hover:bg-[#915EFF] px-2 transition-all duration-300 rounded'>Alejandro</span>
              <motion.span
          ...
          >
            Full Stack Software Engineer based in Los Angeles, CA — passionate about creating innovative and efficient solutions to complex problems.
          </motion.p>
